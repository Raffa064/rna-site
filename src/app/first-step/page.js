...
export default function FirstStep() {
    return (
        <PageContainer>
            ...
            <p>Para utilizar a biblioteca <strong>rna.js</strong> em aplicações <a href="https://nodejs.org/en/about">node</a>, baixe o arquivo da biblioteca na nossa <Link href="/api/lib" download='rna.js' type='text/javascript'>api</Link>, adicione-a ao seu projeto, e por fim, importe-o da seguinte forma:</p>
            <CodePreview code={"import './rna.js'; //isso importara as funções da biblioteca\n\nconst simulation = createSimulation(...)"} lang="javascript"></CodePreview>
